    ...
    def find_gutenberg_books(self):
        ...
        try: 
            ...
            for link in book_links:
                ...
                try: ## Case when no author/sub title
                    found_authors.append(link.find('span', class_ = "subtitle").get_text())
                
                except Exception as e:
                    print('Subtitle not identified')
                    
                    found_authors.append('')
                
                desired_links.append(link.a['href'])
                
            return desired_links, found_titles, found_authors 
            ...
            print(f'A non-requests related error occurred: {e}')
